  ...
  app.get('/v1/chat/users',(req,res) => {
    ...
    /*state[$states.userlist] = Object
      ...
      tempnamelist.forEach(user => {
        ...
        fatchatUserList.push({ [user]: {username:user,watching:{username:user, page: 'NoAgenda' },data:{watching:{username:user, page: 'NoAgenda' },avatar:null,username:user,page:'NoAgenda',color:null}} });
